...
net stop "%name%"
echo "NET stop zapret"
sc delete "%name%"
echo "SC delete zapret"
sc create "%name%" binPath= "%BIN%winws.exe %arguments%" DisplayName= "FuckDiscordPi: Discord Service (YanGusik)" start= auto
echo "SC create zapret "%name%" binPath= "%BIN%winws.exe %arguments%" DisplayName= "FuckDiscordPi: Discord Service (YanGusik)" start= auto"
sc description "%name%" "FuckDiscordPi: Discord service use zapret DPI bypass software"
sc start "%name%"
echo "SC start zapret"
pause